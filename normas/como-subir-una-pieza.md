...
> ⚠️ Antes de crear tu ficha, comprueba en al final de la web a la derecha o en `piezas/index.json` qué IDs ya están en uso para elegir el siguiente disponible.
